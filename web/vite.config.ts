...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Netronome',
        short_name: 'Netronome',
        description: 'Network performance testing and monitoring tool',
        theme_color: '#18181b',
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: /\/api\/speedtest\/history/,
            handler: 'StaleWhileRevalidate',
            options: {
              cacheName: 'speedtest-history-cache',
              expiration: {
                maxEntries: 50,
          ...
          {
            urlPattern: /\/api\/monitor/,
            handler: 'NetworkFirst',
            options: {
              cacheName: 'monitor-data-cache',
